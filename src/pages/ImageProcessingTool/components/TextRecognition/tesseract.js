...
log$2.log = (...args) => (logging ? console.log.apply(this, args) : null);
...
var _excluded = ["language", "errorHandler"];
var useTesseract = function useTesseract() {
  ...
  var _useState5 = useState(false),
    ...
    isRecognizing = _useState6[0],
    setIsRecognizing = _useState6[1];
  var recognize = useCallback( /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _options$language = options.language, language = _options$language === void 0 ? 'eng' : _options$language, errorHandler = options.errorHandler, tesseractOptions = _objectWithoutProperties(options, _excluded);
            _context.prev = 5;
            _context.next = 8;
            return src.createWorker(language);
          case 8:
            worker = _context.sent;
            _context.next = 11;
            return worker.recognize(image, tesseractOptions);
          case 11:
          ...
          case 17:
            ...
            if (errorHandler) errorHandler(_context.t0);
            throw _context.t0;
          case 22:
            _context.prev = 22;
            _context.next = 25;
...
export { useTesseract, Tesseract, languages };
