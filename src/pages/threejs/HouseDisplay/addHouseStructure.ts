...
const wallList = [
  ...
  [4.8, 0.5, w, -0.8, 3.75, -16],
  [4.8, 1.5, w, -0.8, 0.75, -16],
  [1.2, wallHeight, w, -3, wallHeight / 2, -16],
  [1.2, wallHeight, w, 1.4, wallHeight / 2, -16],
  [4.4, 0.5, w, 3.8, 3.75, -16],
  [4.4, 1.5, w, 3.8, 0.75, -16],
  [1.2, wallHeight, w, 1.8, wallHeight / 2, -16],
  [w, wallHeight, 0.8, 17.6, wallHeight / 2, -10.8],
  [11.6, wallHeight, w, 11.8, wallHeight / 2, -16],
  ...
  [w, wallHeight, 3.8, -3.2, wallHeight / 2, -14.0],
  [w, wallHeight, 6.4, 1.6, wallHeight / 2, -12.8],
  [w, wallHeight, 6.8, 6, wallHeight / 2, -12.6],
  [8.4, wallHeight, w, -9.8, wallHeight / 2, 4.4],
  ...
  [3.7, wallHeight, w, -0.9, wallHeight / 2, 4.4],
  ...
  [w, beamHeight, 2.9, -1.35, wallHeight - beamHeight / 2, -8],
  [w, beamHeight, 2.9, 6, wallHeight - beamHeight / 2, -8],
  [w, beamHeight, 2.9, -3.2, wallHeight - beamHeight / 2, -11],
  [2.1, beamHeight, w, 4.85, wallHeight - beamHeight / 2, -9.6],
  [w, beamHeight, 6, -14, wallHeight - beamHeight / 2, 8.5],
  [2.9, beamHeight, w, -4.2, wallHeight - beamHeight / 2, 4.4],
];
// 所有玻璃窗的尺寸和位置
const glassList = [
  [4, 2.5, 0.1, -0.8, 2.5, -16],
  [3.6, 2.5, 0.1, 3.8, 2.5, -16],
