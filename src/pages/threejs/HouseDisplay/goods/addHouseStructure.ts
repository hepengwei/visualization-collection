...
const wallList = [
  ...
  [w, 0.5, 7.12, 17.6, 3.75, -1.92],
  [w, 0.5, 7.12, 17.6, 0.25, -1.92],
  [w, wallHeight, 0.92, 17.6, wallHeight / 2, -5.94],
  [w, wallHeight, 0.92, 17.6, wallHeight / 2, 1.8],
  [w, 0.5, 1.4, 17.6, 3.75, 5.09],
  // #21
  [w, 1.5, 1.4, 17.6, 0.75, 5.09],
  [w, wallHeight, 2.2, 17.6, wallHeight / 2, 3.3],
  [w, wallHeight, 2.94, 17.6, wallHeight / 2, 7.25],
...
const glassList = [
  ...
  [0.1, 3.5, 7.12, 17.6, 2, -1.92],
  [0.1, 2, 1.4, 17.6, 2.5, 5.09],
