...
const LEFT_OR_RIGHT_BOARD_THICKNESS = 0.1; // 左右两边木板的厚度(做圆弧设计)
// 客厅柜的位置
...
const SIDEBOARD_WIDTH = 2.4; // 客厅柜体的总宽（不包含左右两边多出的部分）
const CHEST_GAP = 0.008; // 柜子之间的缝隙
const SIDEBOARD_HEIGHT = WALL_HEIGHT - SUSPENDED_CEILING_HEIGHT; // 客厅柜的总高
...
const DRAWER_WIDTH =
  (SIDEBOARD_WIDTH -
    LEFT_OR_RIGHT_BOARD_THICKNESS * 2 -
...
const addLivingRoomCabinet = (
  ...
  livingRoomCabinet.position.copy(SIDEBOARD_POSITON);
...
const createLivingRoomCabinet = (
  ...
  addBox(
    ...
    assetManager,
    woodBoardLightMaterial,
    LEFT_OR_RIGHT_BOARD_THICKNESS,
    topHeight,
    TOP_STORAGE_AREA_DEPTH,
    (LEFT_OR_RIGHT_BOARD_THICKNESS - SIDEBOARD_WIDTH) / 2,
    SIDEBOARD_HEIGHT - topHeight / 2,
    TOP_STORAGE_AREA_DEPTH / 2 - LEFT_OR_RIGHT_BOARD_THICKNESS,
  );
  // 左上四分之一圆柱
  ...
  generateQuarterCylinder1.position.set(
    LEFT_OR_RIGHT_BOARD_THICKNESS - SIDEBOARD_WIDTH / 2,
    SIDEBOARD_HEIGHT - topHeight,
    TOP_STORAGE_AREA_DEPTH - LEFT_OR_RIGHT_BOARD_THICKNESS,
  );
  ...
  addBox(
    ...
    TOP_STORAGE_AREA_DEPTH,
    LEFT_OR_RIGHT_BOARD_THICKNESS +
      (BOARD_COATING_THICKNESS - SIDEBOARD_WIDTH) / 2,
    SIDEBOARD_HEIGHT - topHeight / 2,
  ...
  addBox(
    ...
    topHeight,
    TOP_STORAGE_AREA_DEPTH,
    (SIDEBOARD_WIDTH - LEFT_OR_RIGHT_BOARD_THICKNESS) / 2,
    SIDEBOARD_HEIGHT - topHeight / 2,
    TOP_STORAGE_AREA_DEPTH / 2 - LEFT_OR_RIGHT_BOARD_THICKNESS,
  );
  // 右上四分之一圆柱
  ...
  generateQuarterCylinder2.position.set(
    SIDEBOARD_WIDTH / 2 - LEFT_OR_RIGHT_BOARD_THICKNESS,
    SIDEBOARD_HEIGHT - topHeight,
    TOP_STORAGE_AREA_DEPTH - LEFT_OR_RIGHT_BOARD_THICKNESS,
  );
  ...
  addBox(
    ...
    topHeight,
    TOP_STORAGE_AREA_DEPTH,
    (SIDEBOARD_WIDTH - BOARD_COATING_THICKNESS) / 2 -
      LEFT_OR_RIGHT_BOARD_THICKNESS,
    SIDEBOARD_HEIGHT - topHeight / 2,
    TOP_STORAGE_AREA_DEPTH / 2,
  );
  ...
  addBox(
    ...
    (LEFT_OR_RIGHT_BOARD_THICKNESS - SIDEBOARD_WIDTH) / 2,
    bottomHeight / 2,
    LIVING_ROOM_CABINET_DEPTH / 2 - LEFT_OR_RIGHT_BOARD_THICKNESS,
  );
  // 左下四分之一圆柱
  ...
  generateQuarterCylinder3.position.set(
    LEFT_OR_RIGHT_BOARD_THICKNESS - SIDEBOARD_WIDTH / 2,
    0,
    LIVING_ROOM_CABINET_DEPTH - LEFT_OR_RIGHT_BOARD_THICKNESS,
  );
  ...
  addBox(
    ...
    0,
    SIDEBOARD_HEIGHT - TOP_CHEST_HEIGHT - CHEST_GAP - BOARD_THICKNESS / 2,
  ...
  for (let i = 0; i < CHEST_COL_COUNT; i++) {
    ...
    addBox(
      ...
      x,
      SIDEBOARD_HEIGHT - TOP_CHEST_HEIGHT / 2,
  ...
  const light1 = addLightingStrip(
    ...
    0,
    SIDEBOARD_HEIGHT - TOP_CHEST_HEIGHT - CHEST_GAP - BOARD_THICKNESS - 0.001,
  ...
  lightingStripLightMapRef.current.livingRoomCabinet = lightList;
